...
**                                 Array de 8 LEDs                              **
**                                                                              **
** Nom: Aleix Llimargas                                       Data: 15/12/2021  **
*********************************************************************************/
...
void setup()
{
  pinMode(led0, INPUT);     // definir el pin 3 com una sortida
  pinMode(led1, INPUT);     // definir el pin 5 com una sortida
  pinMode(led2, INPUT);     // definir el pin 6 com una sortida
  pinMode(led3, INPUT);     // definir el pin 9 com una sortida
  pinMode(led4, INPUT);     // definir el pin 10 com una sortida
  pinMode(led5, INPUT);     // definir el pin 11 com una sortida
}
...
void loop()
{
     ...
     else
   {
    ...
    analogWrite(led3, 0);     // posar PWM del pin 9 a 60
    analogWrite(led4, 0);     // posar PWM del pin 10 a 60
    analogWrite(led5, 0);     // posar PWM del pin 11 a 6
    ...
    analogWrite(led5, 255);     // posar PWM del pin 11 a 6
    ...
    analogWrite(led3, 0);     // posar PWM del pin 9 a 60
    analogWrite(led4, 60);     // posar PWM del pin 10 a 60
    analogWrite(led5, 125);     // posar PWM del pin 11 a 6
    ...
    analogWrite(led3, 0);     // posar PWM del pin 9 a 60
    analogWrite(led4, 0);     // posar PWM del pin 10 a 60
    analogWrite(led5, 60);     // posar PWM del pin 11 a 6
